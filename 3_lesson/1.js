...
// в соответствующую температуру в градусах по Фаренгейту и вывести в alert сообщение 
...
function translFahrenheit(num) {
    return Math.round(((9 / 5) * num + 32) * 10) / 10;
}
alert(`Цельсий: ${a}, Фаренгейт: ${translFahrenheit(a)}`);